 ...
 *
 * `agencies.report_email` is the address the Settings page offers for a
 ...
 * workspace (lib/email/agency-recipients.ts).
 *
...
export async function reportRecipients(
  ...
  return agencyRecipients(supabase, agencyId, workspaceId);
}
