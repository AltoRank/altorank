  ...
  return (
    <>
      <PageHead
        ...
        eyebrow={
          <>
            <span className="font-mono px-[7px] py-0.5 bg-panel-2 rounded text-ink-2">{workspace.domain}</span>
        ...
        subtitle={
          <>
            ...
            <DotSep />
            <span>{workspace.traffic} organic /mo</span>
            <DotSep />
            <span>DR {workspace.dr}</span>
            <DotSep />
