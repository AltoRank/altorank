...
export const ArticleImage = Node.create({
  ...
  renderHTML({ node, HTMLAttributes }) {
    ...
    const img: [string, Record<string, unknown>] = ["img", mergeAttributes(rest, { loading: "lazy" })];
...
export const enrichmentNodes = [HeadingIds, ArticleImage, VideoEmbed, InfographicFigure];
