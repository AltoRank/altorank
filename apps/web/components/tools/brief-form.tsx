...
const INITIAL_STATE: BriefActionState = { success: false };
    ...
    <div>
      <form action={formAction} className="flex flex-col gap-3 sm:flex-row">
        <input
          ...
          minLength={2}
          maxLength={100}
          placeholder="Enter a keyword (e.g. best crm for startups)"
      ...
      {/* Result */}
      {state.success && state.brief && <BriefResult brief={state.brief} />}
    </div>
  );
}
